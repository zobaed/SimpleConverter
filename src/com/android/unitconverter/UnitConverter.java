...
public class UnitConverter extends Activity implements OnClickListener, AdapterView.OnItemSelectedListener{
    ...
    public void onItemSelected(AdapterView<?> parent, View v,
    	...
    	if(v.getParent() == SpinnerUnit){
			...
			imm.hideSoftInputFromWindow(getCurrentFocus().getWindowToken(), 0);
        		...
        		//if from & to spinner is not clicked thn fst will be selctd :p 
    ...
    private void fillFromToSpinner(int position){
    	...
    	case 8:
    		...
    		break;
    	case 9:
    		fillSpinnerWithMoneyUnit();
    		break;
    	}
    	
    }
    
    private void fillSpinnerWithMoneyUnit() {
		// TODO Auto-generated method stub
    	unitarrayadapter.clear();
    	
    	unitarrayadapter.add(getResources().getString(R.string.currencyunitdollar));
    	unitarrayadapter.add(getResources().getString(R.string.currencyuniteuro));
    	unitarrayadapter.add(getResources().getString(R.string.currencyunitpound));
    	unitarrayadapter.add(getResources().getString(R.string.currencyunittk));
	...
	private void fillSpinnerWithTimeUnit() {
		// TODO Auto-generated method stub
    	unitarrayadapter.clear();
    	unitarrayadapter.add(getResources().getString(R.string.Timeunithour));
    	unitarrayadapter.add(getResources().getString(R.string.Timeunitminute));
    	unitarrayadapter.add(getResources().getString(R.string.Timeunitsecond));
    	unitarrayadapter.add(getResources().getString(R.string.Timeunitday));
    	unitarrayadapter.add(getResources().getString(R.string.Timeunityear));
    ...
    public void onClick(View v){
    	if(v == ButtonConvert){
    		if(!inputValue.getText().toString().equals("")){
    			 sn = inputValue.getText().toString();
